...
export const aiDataExtractionDescription: INodeProperties[] = [
	...
	},
	{
		...
		default: {},
		displayOptions: { show: { ...show, operation: ['aiQuery'] } },
		description: 'Restrict the analysis to specific page types',
		options: [
			{
				...
				routing: { send: { type: 'body', property: 'specific_pages.about_us' } },
			},
			{
				displayName: 'Blog',
				name: 'blog',
				...
				routing: { send: { type: 'body', property: 'specific_pages.blog' } },
			},
			{
				displayName: 'Careers',
				name: 'careers',
				...
				routing: { send: { type: 'body', property: 'specific_pages.careers' } },
			},
			{
				...
				routing: { send: { type: 'body', property: 'specific_pages.contact_us' } },
			},
			{
				displayName: 'FAQ',
				name: 'faq',
				...
				routing: { send: { type: 'body', property: 'specific_pages.faq' } },
			},
			{
				...
				routing: { send: { type: 'body', property: 'specific_pages.home_page' } },
			},
			{
				displayName: 'Pricing',
				name: 'pricing',
				...
				routing: { send: { type: 'body', property: 'specific_pages.pricing' } },
			},
			{
				...
				routing: { send: { type: 'body', property: 'specific_pages.privacy_policy' } },
			},
			{
				...
				routing: { send: { type: 'body', property: 'specific_pages.terms_and_conditions' } },
			},
		],
	},
	{
